$('#submitbtn').click(function(){
    swal({
        title: "Plagiarism Test Running",
        text: "The page will refresh with the results",
        icon: "success",
      })
});

$('#useSite').click(function(){
    swal({
        title: "Redirecting to COPYLEAKS",
        text: "Follow the instructions in the Website",
      })
    window.open('https://copyleaks.com/compare', '_blank');
});
...
var email = 'studentenrolmentnsbm@gmail.com';
var apikey = '748A9A13-CA2C-4E9E-9D25-3279E281476C';
	...
	*/
	...
	function callback(resp,err){
		...
		*/
		...
		_customHeaders[config.HTTP_CALLBACK] = 'https://envphm54pu76.x.pipedream.net'
